...
class PostgresDB:
    ...
    def save_raw_json_season_stats(self, player_id, season, competition, raw_json):
        createdate = datetime.now()
        insert_query = """
            INSERT INTO fotmob_data.raw_player_stats (player_id, createdate, season, competition, raw_json)
            VALUES (%s, %s, %s, %s, %s)
